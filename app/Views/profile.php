        ...
        <div class="d-flex flex-column align-item-center row-gap-2">
            ...
            <div class="group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" readonly class="form-control border-start-0" placeholder="masukkan nama depan anda" aria-label="firstname" value="<?= $profile->first_name; ?>"" aria-describedby=" basic-addon2" name="firstname" id="lastname" required />
                </div>
            </div>
            <div class="group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" readonly class="form-control border-start-0" placeholder="masukkan nama belakang anda" aria-label="lastname" value="<?= $profile->last_name; ?>" aria-describedby="basic-addon3" name="lastname" id="lastname" required />
                </div>
            </div>
            <a href="<?= base_url('account/update') ?>" class="btn btn-disable fw-bold text-danger border-danger">Edit</a>
            <a href="<?= base_url('logout') ?>" class="btn btn-danger fw-bold">Logout</a>
        </div>
    </div>
